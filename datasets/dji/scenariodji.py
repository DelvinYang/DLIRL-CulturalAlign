"""Scenario helpers built on top of :mod:`src.read_data_dji`."""
...
from .common import *
from .read_data_dji import DataReaderDJI
...
class ScenarioDJI:
    """Wrapper around :class:`DataReaderDJI` providing vehicle utilities."""

    def __init__(self, data_reader: DataReaderDJI):
        self.data_reader = data_reader
        self.vehicles, self.id_list = self.set_vehicles()
        self.frame_rate = self.data_reader.recordingMeta[FRAME_RATE]
        logger.info("[ScenarioDJI] Imported {} vehicles", len(self.id_list))
