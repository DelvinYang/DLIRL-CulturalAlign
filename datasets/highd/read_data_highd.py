"""Utility for reading HighD interaction dataset annotations."""
...
class DataReaderHighD:
    """Read the HighD dataset for a given recording prefix."""
    ...
    def generate_path(self) -> Tuple[str, str, str, str]:
        ...
        tracks_path = os.path.join(self.data_path, f"{self.prefix_number}_tracks.csv")
        tracks_meta_path = os.path.join(self.data_path, f"{self.prefix_number}_tracksMeta.csv")
        recording_meta_path = os.path.join(self.data_path, f"{self.prefix_number}_recordingMeta.csv")
        background_path = os.path.join(self.data_path, f"{self.prefix_number}_highway.png")
